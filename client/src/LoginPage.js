        ...
        <div className="row justify-content-center">
          <div className="col-md-6" style={{backgroundColor:'#88876B', padding:'200px 100px',display:'flex'}}>
            <div style={{ height: "100vh", width: "100%", position: "relative", alignSelf:'center'}}>
              <p className={`${styles.home_txt} ${styles.txt_1}`}>Connecting the blah ancient blah to blah</p>
              ...
              <p className={`${styles.home_txt} ${styles.txt_2}`}>Some more blah on top of other blah</p>
            </div>
          </div>
